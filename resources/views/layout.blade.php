...
<head>
    ...
    <title>Car Rental - Thuê xe du lịch</title>
    ...
    <link rel='stylesheet' href='{{asset("js/plugins/grandcarrental-custom-post/css/fontawesome-stars-o.css")}}'
        type='text/css' media='all' />
    <link rel='stylesheet' href='{{asset("js/plugins/post-views-counter/css/frontend.css")}}' type='text/css'
        media='all' />
    ...
    <!-- <link rel='stylesheet' href='{{asset("js/plugins/mediaelement/mediaelementplayer-legacy.min.css")}}' type='text/css' -->
    media='all' />
    ...
    <link rel='stylesheet'
        href='{{asset("https://fonts.googleapis.com/css?family=Work+Sans%3A100%2C200%2C300%2Cregular%2C500%2C600%2C700%2C800%2C900%7CPoppins%3A300%2Cregular%2C500%2C600%2C700%2C900&#038;subset")}}'
        type='text/css' media='all' />
...
<body class="home page-template-default page page-id-3075 woocommerce-no-js ppb_enable">
            ...
            <div class="menu-main-menu-container">
                <ul id="mobile_main_menu" class="mobile_main_nav">
                    <li class="menu-item current-menu-item menu-item-has-children"><a href="/">Trang chủ</a>
                        <ul class="sub-menu">
                            <li class="menu-item"><a href="/">Trang chủ 1 – Background Image</a></li>
                            <li class="menu-item"><a href="home-2-youtube-video.html">Trang chủ 2 – Youtube Video</a>
                            </li>
                            <li class="menu-item"><a href="home-3-google-inspired.html">Trang chủ 3 – Google
                                    Inspired</a>
                            </li>
                            <li class="menu-item"><a href="home-4-limousine-service.html">Trang chủ 4 – Limousine
                                    Service</a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu-item menu-item-has-children"><a href="#">Các dòng xe</a>
                        <ul class="sub-menu">
                            <li class="menu-item menu-item-has-children"><a href="car-list-right-sidebar.html">Car List
                                    Sidebar</a>
                                <ul class="sub-menu">
                            ...
                            <li class="menu-item menu-item-has-children"><a
                                    href="car-list-thumbnail-right-sidebar.html">Car List Thumbnail Sidebar</a>
                                <ul class="sub-menu">
                                    <li class="menu-item"><a href="car-list-thumbnail-right-sidebar.html">Right
                                            Sidebar</a></li>
                                    <li class="menu-item"><a href="car-list-thumbnail-left-sidebar.html">Left
                                            Sidebar</a></li>
                                </ul>
                            </li>
                            <li class="menu-item menu-item-has-children"><a href="car-2-columns-classic.html">Car
                                    Classic Fullwidth</a>
                                <ul class="sub-menu">
                            ...
                            <li class="menu-item menu-item-has-children"><a
                                    href="car-2-columns-classic-right-sidebar.html">Car Classic Right Sidebar</a>
                                <ul class="sub-menu">
                                    <li class="menu-item"><a href="car-2-columns-classic-right-sidebar.html">Right
                                            Sidebar</a></li>
                                    <li class="menu-item"><a href="car-2-columns-classic-left-sidebar.html">Left
                                            Sidebar</a></li>
                                </ul>
                            </li>
                            <li class="menu-item menu-item-has-children"><a href="car-2-columns-grid.html">Car Grid
                                    Fullwidth</a>
                                <ul class="sub-menu">
                            ...
                            <li class="menu-item menu-item-has-children"><a href="car-grid-right-sidebar.html">Car Grid
                                    Sidebar</a>
                                <ul class="sub-menu">
                            ...
                            <li class="menu-item"><a href="car-by-brand-type-fullwidth.html">Car By Brand &#038; Type
                                    Fullwidth</a></li>
                    ...
                    <li class="menu-item menu-item-has-children"><a href="#">Thuê xe</a>
                        <ul class="sub-menu">
                ...
                <div class="page_content_wrapper">
                    ...
                    <div class="top_contact_info">
                        <div class="company_address">
                            <div id="top_contact_address"><span class="ti-location-pin"></span>184 Main Street East 8007
                            </div>
                        </div>
                        <div>
                                        ...
                                        <div class="menu-main-menu-container">
                                            <ul id="main_menu" class="nav">
                                                <li class="menu-item current-menu-item menu-item-has-children arrow"><a
                                                        href="/">Trang chủ</a>
                                                    <ul class="sub-menu">
                                                        <li class="menu-item"><a href="/">Trang chủ 1 –
                                                                Background
                                                                Image</a></li>
                                                        <li class="menu-item"><a href="home-2-youtube-video.html">Trang
                                                                chủ 2
                                                                – Youtube Video</a></li>
                                                        <li class="menu-item"><a
                                                                href="home-3-google-inspired.html">Trang chủ
                                                                3 – Google Inspired</a></li>
                                                        <li class="menu-item"><a
                                                                href="home-4-limousine-service.html">Trang chủ 4 –
                                                                Limousine
                                                                Service</a></li>
                                                    </ul>
                                                </li>
                                                <li class="menu-item menu-item-has-children arrow"><a href="#">Các dòng
                                                        xe</a>
                                                    <ul class="sub-menu">
                                                        <li class="menu-item menu-item-has-children arrow"><a
                                                                href="car-list-right-sidebar.html">Car List Sidebar</a>
                                                            <ul class="sub-menu">
                                                                <li class="menu-item"><a
                                                                        href="car-list-right-sidebar.html">Right
                                                                        Sidebar</a></li>
                                                                <li class="menu-item"><a
                                                                        href="car-list-left-sidebar.html">Left
                                                                        Sidebar</a></li>
                                                            </ul>
                                                        </li>
                                                        <li class="menu-item menu-item-has-children arrow"><a
                                                                href="car-list-thumbnail-right-sidebar.html">Car List
                                                                Thumbnail Sidebar</a>
                                                            <ul class="sub-menu">
                                                                <li class="menu-item"><a
                                                                        href="car-list-thumbnail-right-sidebar.html">Right
                                                                        Sidebar</a></li>
                                                                <li class="menu-item"><a
                                                                        href="car-list-thumbnail-left-sidebar.html">Left
                                                                        Sidebar</a></li>
                                                            </ul>
                                                        </li>
                                                        <li class="menu-item menu-item-has-children arrow"><a
                                                                href="car-2-columns-classic.html">Car Classic
                                                                Fullwidth</a>
                                                            <ul class="sub-menu">
                                                                <li class="menu-item"><a
                                                                        href="car-2-columns-classic.html">2 Columns</a>
                                                                </li>
                                                                <li class="menu-item"><a
                                                                        href="car-3-columns-classic.html">3 Columns</a>
                                                                </li>
                                                                <li class="menu-item"><a
                                                                        href="car-4-columns-classic.html">4 Columns</a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        <li class="menu-item menu-item-has-children arrow"><a
                                                                href="car-2-columns-classic-right-sidebar.html">Car
                                                                Classic Right Sidebar</a>
                                                            <ul class="sub-menu">
                                                                <li class="menu-item"><a
                                                                        href="car-2-columns-classic-right-sidebar.html">Right
                                                                        Sidebar</a></li>
                                                                <li class="menu-item"><a
                                                                        href="car-2-columns-classic-left-sidebar.html">Left
                                                                        Sidebar</a></li>
                                                            </ul>
                                                        </li>
                                                        <li class="menu-item menu-item-has-children arrow"><a
                                                                href="car-2-columns-grid.html">Car Grid Fullwidth</a>
                                                            <ul class="sub-menu">
                                                                <li class="menu-item"><a
                                                                        href="car-2-columns-grid.html">2 Columns</a>
                                                                </li>
                                                                <li class="menu-item"><a
                                                                        href="car-3-columns-grid.html">3 Columns</a>
                                                                </li>
                                                                <li class="menu-item"><a
                                                                        href="car-4-columns-grid.html">4 Columns</a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        <li class="menu-item menu-item-has-children arrow"><a
                                                                href="car-grid-right-sidebar.html">Car Grid Sidebar</a>
                                                            <ul class="sub-menu">
                                                                <li class="menu-item"><a
                                                                        href="car-grid-right-sidebar.html">Right
                                                                        Sidebar</a></li>
                                                                <li class="menu-item"><a
                                                                        href="car-grid-left-sidebar.html">Left
                                                                        Sidebar</a></li>
                                                            </ul>
                                                        </li>
                                                        <li class="menu-item"><a
                                                                href="car-by-brand-type-fullwidth.html">Car By Brand
                                                                &#038; Type Fullwidth</a></li>
                                                        <li class="menu-item menu-item-has-children arrow"><a
                                                                href="#">Car By Brands</a>
                                                            <ul class="sub-menu">
                                                                <li class="menu-item"><a href="audi.html">Audi</a></li>
                                                                <li class="menu-item"><a href="bmw.html">BMW</a></li>
                                                                <li class="menu-item"><a href="lexus.html">Lexus</a>
                                                                </li>
                                                                <li class="menu-item"><a
                                                                        href="mercedes-benz.html">Mercedes Benz</a></li>
                                                                <li class="menu-item"><a href="porsche.html">Porsche</a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        <li class="menu-item menu-item-has-children arrow"><a
                                                                href="#">Car By Types</a>
                                                            <ul class="sub-menu">
                                                                <li class="menu-item"><a href="coupe.html">Coupe</a>
                                                                </li>
                                                                <li class="menu-item"><a href="sedan.html">Sedan</a>
                                                                </li>
                                                                <li class="menu-item"><a href="suv.html">SUV</a></li>
                                                            </ul>
                                                        </li>
                                                ...
                                                <li class="menu-item menu-item-has-children arrow"><a href="#">Thuê
                                                        xe</a>
                                                    <ul class="sub-menu">
                                                        <li class="menu-item"><a href="audi-a4.html">Car Rental</a></li>
                                                        <li class="menu-item"><a href="porsche-boxster.html">Car Rental
                                                                Compact Form</a></li>
                                                        <li class="menu-item"><a href="mercedes-benz-gle.html">Limousine
                                                                One Way Transfer</a></li>
                                                        <li class="menu-item"><a href="porsche-cayenne.html">Limousine
                                                                Hourly Service</a></li>
                                                        <li class="menu-item"><a href="lexus-rx-350.html">Request for
                                                                Booking Only</a></li>
                                                        <li class="menu-item"><a href="bmw-3-series.html">Standard
                                                                Background Header</a></li>
                                                        <li class="menu-item"><a
                                                                href="mercedes-benz-cls-class.html">Video Background
                                                                Header</a></li>
                                                    </ul>
                                                </li>
                                            </ul>
            ...
            <ul class="sidebar_widget three">
                <li id="text-2" class="widget widget_text">
                    ...
                    <div class="textwidget">
                        <p>Mặc quần áo và đi du lịch với những người bạn tốt sẽ tạo nên một trải nghiệm khó quên. </p>
                ...
                <li id="text-3" class="widget widget_text">
                    ...
                    <div class="textwidget">
                        <p><span class="ti-mobile" style="margin-right:10px;"></span>0879533534</p>
                        <p><span class="ti-location-pin" style="margin-right:10px;"></span>98 TCH 35, Quận 12, TP. HCM
                        </p>
                        <p><span class="ti-alarm-clock" style="margin-right:10px;"></span>Tất cả các ngày trừ CN, ngày
                            lễ</p>
                        <div style="margin-top:20px;">
                            <div class="social_wrapper shortcode dark ">
                                <ul>
                                    ...
                                    <li class="instagram"><a target="_blank" title="Instagram"
                                            href="https://instagram.com/theplanetd"><i class="fa fa-instagram"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
    ...
    <script type='text/javascript'
        src='js/plugins/revslider/public/assets/js/jquery.themepunch.revolution.min.js'></script>
    <script type="text/javascript">
