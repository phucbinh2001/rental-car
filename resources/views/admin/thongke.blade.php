...
<div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex no-block">
                        <h4 class="card-title">Earning Report<br /><small class="text-muted">Emplyee earning
                                report</small></h4>
                        <div class="ml-auto">
                ...
                <div class="bg-light p-20">
                    <div class="d-flex">
                        <div class="align-self-center">
                            <h3 class="m-b-0">July 2017</h3><small>Total Earning</small>
                        </div>
                        <div class="ml-auto align-self-center">
                            <h2 class="text-success">$5470</h2>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                <tr>
                                    <td style="width:50px;"><span class="round"><img
                                                src="./admin_site/assets/images/users/8.jpg" alt="user"
                                                width="50"></span></td>
                                    <td>
                                ...
                                <tr class="active">
                                    <td><span class="round"><img src="./admin_site/assets/images/users/2.jpg" alt="user"
                                                width="50"></span></td>
                                    <td>
                                ...
                                <tr>
                                    <td><span class="round round-success"><img
                                                src="./admin_site/assets/images/users/1.jpg" alt="user"
                                                width="50"></span></td>
                                    <td>
                                ...
                                <tr>
                                    <td><span class="round round-primary"><img
                                                src="./admin_site/assets/images/users/4.jpg" alt="user"
                                                width="50"></span></td>
                                    <td>
                                ...
                                <tr>
                                    <td><span class="round round-warning"><img
                                                src="./admin_site/assets/images/users/5.jpg" alt="user"
                                                width="50"></span></td>
                                    <td>
                                ...
                                <tr>
                                    <td><span class="round round-danger"><img
                                                src="./admin_site/assets/images/users/1.jpg" alt="user"
                                                width="50"></span></td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h6>Vishal Doe</h6><small class="text-muted">Content Writer</small>
                                    </td>
                                    <td><span class="label label-warning">High</span></td>
                                    <td>$12.9K</td>
                                </tr>
            ...
            <div class="card">
                ...
                <div class="comment-widgets m-b-20">
                    ...
                    <div class="d-flex flex-row comment-row">
                        <div class="p-2"><span class="round"><img src="./admin_site/assets/images/users/1.jpg"
                    ...
                    <!-- Comment Row -->
                    <div class="d-flex flex-row comment-row ">
                        <div class="p-2"><span class="round"><img src="./admin_site/assets/images/users/2.jpg"
                                    alt="user" width="50"></span></div>
                    ...
                    <!-- Comment Row -->
                    <div class="d-flex flex-row comment-row">
                        <div class="p-2"><span class="round"><img src="./admin_site/assets/images/users/3.jpg"
                                    alt="user" width="50"></span></div>
                        <div class="comment-text w-100">
                    ...
                    <!-- Comment Row -->
                    <div class="d-flex flex-row comment-row">
                        <div class="p-2"><span class="round"><img src="./admin_site/assets/images/users/4.jpg"
                                    alt="user" width="50"></span></div>
                        <div class="comment-text w-100">
                            <h5>James Anderson</h5>
                            <div class="comment-footer">
                    ...
                    <div id="myCarouse3" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item flex-column carousel-item-next carousel-item-left">
                                ...
                                <p class="text-white">25th Jan</p>
                                <h3 class="text-white font-light">Tweet now <span class="font-bold">50%
                                        Off</span><br>
                                    on buy</h3>
                                <div class="text-white m-t-20">
                                    <i>- @shoperstaff</i>
                            ...
                            <div class="carousel-item flex-column">
                                <i class="fa fa-twitter fa-2x text-white"></i>
                                <p class="text-white">25th Jan</p>
                                <h3 class="text-white font-light">Sachin #star <span class="font-bold">50%
                                        Off</span><br>
                                    on buy</h3>
                                <div class="text-white m-t-20">
                                    <i>- #shoperstaff</i>
    ...
    <div class="row">
                ...
                <div class="card-body">
                    ...
                    <div class="chat-box">
                        ...
                        <ul class="chat-list">
                            <!--chat Row -->
                            <li>
                                <div class="chat-img"><img src="./admin_site/assets/images/users/1.jpg" alt="user" />
                                </div>
                            ...
                            <!--chat Row -->
                            <li>
                                <div class="chat-img"><img src="./admin_site/assets/images/users/2.jpg" alt="user" />
                                </div>
                                <div class="chat-content">
                                    <h5>Bianca Doe</h5>
                            ...
                            <li class="reverse">
                                ...
                                <div class="chat-img"><img src="./admin_site/assets/images/users/5.jpg" alt="user" />
                                </div>
                                <div class="chat-time">10:57 am</div>
                            </li>
                            <!--chat Row -->
                            ...
                            <!--chat Row -->
                            <li>
                                <div class="chat-img"><img src="./admin_site/assets/images/users/3.jpg" alt="user" />
                                </div>
                                <div class="chat-content">
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    <button class="pull-right btn btn-sm btn-rounded btn-info" data-toggle="modal"
                    ...
                    <div class="to-do-widget m-t-20">
                        ...
                        <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                            <li class="list-group-item" data-role="task">
                                ...
                                <ul class="assignedto">
                                    <li><img src="./admin_site/assets/images/users/1.jpg" alt="user"
                                            data-toggle="tooltip" data-placement="top" title=""
                                            data-original-title="Steave"></li>
                                    <li><img src="./admin_site/assets/images/users/2.jpg" alt="user"
                                            data-toggle="tooltip" data-placement="top" title=""
                                            data-original-title="Jessica"></li>
                                    <li><img src="./admin_site/assets/images/users/3.jpg" alt="user"
                                            data-toggle="tooltip" data-placement="top" title=""
                                            data-original-title="Priyanka"></li>
                                    <li><img src="./admin_site/assets/images/users/4.jpg" alt="user"
                                            data-toggle="tooltip" data-placement="top" title=""
                            ...
                            <li class="list-group-item" data-role="task">
                                <div class="checkbox checkbox-info">
                                    ...
                                    <label for="inputCall" class=""> <span>Give Purchase report to</span>
                                        <span class="label label-danger">Today</span> </label>
                                </div>
                                <ul class="assignedto">
                                    <li><img src="./admin_site/assets/images/users/3.jpg" alt="user"
                                            data-toggle="tooltip" data-placement="top" title=""
    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="profiletimeline m-t-40">
                        <div class="sl-item">
                            <div class="sl-left"> <img src="./admin_site/assets/images/users/1.jpg" alt="user"
                                ...
                                <div><a href="#" class="link">John Doe</a> <span class="sl-date">5 minutes
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 col-md-6 m-b-20"><img
                                                src="./admin_site/assets/images/big/img1.jpg" alt="user"
                                                class="img-responsive radius"></div>
                                        <div class="col-lg-3 col-md-6 m-b-20"><img
                                                src="./admin_site/assets/images/big/img2.jpg" alt="user"
                                                class="img-responsive radius"></div>
                                        <div class="col-lg-3 col-md-6 m-b-20"><img
                                                src="./admin_site/assets/images/big/img3.jpg" alt="user"
                                                class="img-responsive radius"></div>
                                        <div class="col-lg-3 col-md-6 m-b-20"><img
                                                src="./admin_site/assets/images/big/img4.jpg" alt="user"
                                                class="img-responsive radius"></div>
                                    </div>
                        ...
                        <hr>
                        <div class="sl-item">
                            <div class="sl-left"> <img src="./admin_site/assets/images/users/2.jpg" alt="user"
                                    class="img-circle"> </div>
                            <div class="sl-right">
                                <div> <a href="#" class="link">John Doe</a> <span class="sl-date">5 minutes
                                        ago</span>
                        ...
                        <hr>
                        <div class="sl-item">
                            <div class="sl-left"> <img src="./admin_site/assets/images/users/3.jpg" alt="user"
                                    class="img-circle"> </div>
                            <div class="sl-right">
                                <div><a href="#" class="link">John Doe</a> <span class="sl-date">5 minutes
                                        ago</span>
                        ...
                        <hr>
                        <div class="sl-item">
                            <div class="sl-left"> <img src="./admin_site/assets/images/users/4.jpg" alt="user"
                                    class="img-circle"> </div>
                            <div class="sl-right">
                                <div><a href="#" class="link">John Doe</a> <span class="sl-date">5 minutes
                                        ago</span>
        ...
        <div class="col-lg-4 col-xlg-3">
            <!-- Column -->
            <div class="card">
                <img class="card-img-top" src="./admin_site/assets/images/background/profile-bg.jpg"
                    alt="Card image cap">
                <div class="card-body little-profile text-center">
                    <div class="pro-img"><img src="./admin_site/assets/images/users/4.jpg" alt="user" />
                    </div>
                    <h3 class="m-b-0">Angela Dominic</h3>
                    <p>Web Designer &amp; Developer</p>
                    <button href="javascript:void(0)"
                        class="m-t-10 waves-effect waves-dark btn btn-info btn-md btn-rounded">Follow</button>
            ...
            <div class="card">
                <div class="card-body bg-inverse"
                    style="background: url(./admin_site/assets/images/background/user-info.jpg) / cover;">
                ...
                <div class="card-body">
                    <div class="message-box contact-box">
                        ...
                        <div class="message-widget contact-widget">
                            <!-- Message -->
                            <a href="#">
                                <div class="user-img"> <img src="./admin_site/assets/images/users/1.jpg" alt="user"
                            ...
                            <!-- Message -->
                            <a href="#">
                                <div class="user-img"> <img src="./admin_site/assets/images/users/2.jpg" alt="user"
                            ...
                            <!-- Message -->
                            <a href="#">
                                <div class="user-img"> <img src="./admin_site/assets/images/users/4.jpg" alt="user"
        ...
        <div class="slimscrollright">
            ...
            <div class="r-panel-body">
                ...
                <ul class="m-t-20 chatonline">
                    ...
                    <li>
                        <a href="javascript:void(0)"><img src="./admin_site/assets/images/users/1.jpg" alt="user-img"
                                class="img-circle"> <span>Varun Dhavan <small
                                    class="text-success">online</small></span></a>
                    </li>
                    <li>
                        <a href="javascript:void(0)"><img src="./admin_site/assets/images/users/2.jpg" alt="user-img"
                                class="img-circle"> <span>Genelia Deshmukh <small
                                    class="text-warning">Away</small></span></a>
                    </li>
                    <li>
                        <a href="javascript:void(0)"><img src="./admin_site/assets/images/users/3.jpg" alt="user-img"
                                class="img-circle"> <span>Ritesh Deshmukh <small
                                    class="text-danger">Busy</small></span></a>
                    </li>
                    <li>
                        <a href="javascript:void(0)"><img src="./admin_site/assets/images/users/4.jpg" alt="user-img"
                                class="img-circle"> <span>Arijit Sinh <small
                                    class="text-muted">Offline</small></span></a>
                    </li>
                    <li>
                        <a href="javascript:void(0)"><img src="./admin_site/assets/images/users/5.jpg" alt="user-img"
                                class="img-circle"> <span>Govinda Star <small
                                    class="text-success">online</small></span></a>
                    </li>
                    <li>
                        <a href="javascript:void(0)"><img src="./admin_site/assets/images/users/6.jpg" alt="user-img"
                                class="img-circle"> <span>John Abraham<small
                                    class="text-success">online</small></span></a>
                    </li>
                    <li>
                        <a href="javascript:void(0)"><img src="./admin_site/assets/images/users/7.jpg" alt="user-img"
                                class="img-circle"> <span>Hritik Roshan<small
                                    class="text-success">online</small></span></a>
                    </li>
                    <li>
                        <a href="javascript:void(0)"><img src="./admin_site/assets/images/users/8.jpg" alt="user-img"
