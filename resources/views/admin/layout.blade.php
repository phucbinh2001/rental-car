...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href='{{asset("admin_site/assets/images/favicon.png")}}'>
    <title>Admin cho thuê xe</title>
    <base href='{{asset("admin_site")}}'>
    <!-- Bootstrap Core CSS -->
    <link href='{{asset("admin_site/assets/plugins/bootstrap/css/bootstrap.min.css")}}' rel="stylesheet">
    <!-- morris CSS -->
    <link href='{{asset("admin_site/assets/plugins/morrisjs/morris.css")}}' rel="stylesheet">
    <!-- Custom CSS -->
    <link href='{{asset("admin_site/css/style.css")}}' rel="stylesheet">
    <!-- You can change the theme colors from here -->
    <link href='{{asset("admin_site/css/colors/blue.css")}}' id="theme" rel="stylesheet">
...
<body class="fix-header fix-sidebar card-no-border">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        <!-- Logo icon --><b>
                            ...
                            <!-- Dark Logo icon -->
                            <img src="./admin_site/assets/images/logo-icon.png" alt="homepage" class="dark-logo" />
                            <!-- Light Logo icon -->
                            <img src="./admin_site/assets/images/logo-light-icon.png" alt="homepage"
                                class="light-logo" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text --><span>
                            <!-- dark Logo text -->
                            <img src="./admin_site/assets/images/logo-text.png" alt="homepage" class="dark-logo" />
                            <!-- Light Logo text -->
                            <img src="./admin_site/assets/images/logo-light-text.png" class="light-logo"
                                alt="homepage" />
                        </span>
                    </a>
                </div>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="./admin_site/assets/images/users/1.jpg"
                                            ...
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="./admin_site/assets/images/users/2.jpg"
                                                        alt="user" class="img-circle"> <span
                                            ...
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="./admin_site/assets/images/users/3.jpg"
                                                        alt="user" class="img-circle"> <span
                                            ...
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="./admin_site/assets/images/users/4.jpg"
                                                        alt="user" class="img-circle"> <span
                                            ...
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item active">
                                                    <div class="container"> <img class="d-block img-fluid"
                                                            src="./admin_site/assets/images/big/img1.jpg"
                                                            alt="First slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid"
                                                            src="./admin_site/assets/images/big/img2.jpg"
                                                            alt="Second slide">
                                                    </div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid"
                                                            src="./admin_site/assets/images/big/img3.jpg"
                                                            alt="Third slide"></div>
                                                </div>
                                            </div>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href=""
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                    src="./admin_site/assets/images/users/1.jpg" alt="user" class="profile-pic" /></a>
                            <div class="dropdown-menu dropdown-menu-right scale-up">
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            <div class="u-img"><img src="./admin_site/assets/images/users/1.jpg"
                                                    alt="user"></div>
                                            <div class="u-text">
                                                <h4>Steave Jobs</h4>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <div class="user-profile">
                    <!-- User profile image -->
                    <div class="profile-img"> <img src="./admin_site/assets/images/users/profile.png" alt="user" />
                    ...
                    <div class="profile-text">
                        ...
                        <a href="/thoat" class="" data-toggle="tooltip" title="Logout"><i class="mdi mdi-power"></i></a>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i
                                    class="mdi mdi-bullseye"></i><span class="hide-menu">Quản lý xe</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{route('carlist.index')}}">Danh sách xe</a></li>
                                <li><a href="{{route('carlist.create')}}">Thêm xe mới</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="/donhang"><i
                                    class="mdi mdi-email"></i><span class="hide-menu">Đơn hàng</span></a>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    @if(isset($titlePage))
                    <h3 class="text-themecolor">{{$titlePage}}</h3>
                    @else
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="{{asset('admin_site/assets/plugins/jquery/jquery.min.js')}}"></script>
    <!-- Bootstrap tether Core JavaScript -->
    <script src="{{asset('admin_site/assets/plugins/bootstrap/js/popper.min.js')}}"></script>
    <script src="{{asset('admin_site/assets/plugins/bootstrap/js/bootstrap.min.js')}}"></script>
    <!-- slimscrollbar scrollbar JavaScript -->
    <script src="{{asset('admin_site/js/jquery.slimscroll.js')}}"></script>
    <!--Wave Effects -->
    <script src="{{asset('admin_site/js/waves.js')}}"></script>
    <!--Menu sidebar -->
    <script src="{{asset('admin_site/js/sidebarmenu.js')}}"></script>
    <!--stickey kit -->
    <script src="{{asset('admin_site/assets/plugins/sticky-kit-master/dist/sticky-kit.min.js')}}"></script>
    <!--Custom JavaScript -->
    <script src="{{asset('admin_site/js/custom.min.js')}}"></script>
    <!-- ============================================================== -->
    <!-- This page plugins -->
    <!-- ============================================================== -->
    <!--sparkline JavaScript -->
    <script src="{{asset('admin_site/assets/plugins/sparkline/jquery.sparkline.min.js')}}"></script>
    <!--morris JavaScript -->
    <script src="{{asset('admin_site/assets/plugins/raphael/raphael-min.js')}}"></script>
    <script src="{{asset('admin_site/assets/plugins/morrisjs/morris.min.js')}}"></script>
    <!-- Chart JS -->
    <script src="{{asset('admin_site/js/dashboard1.js')}}"></script>
    <!-- ============================================================== -->
    <!-- Style switcher -->
    <!-- ============================================================== -->
    <script src="{{asset('admin_site/assets/plugins/styleswitcher/jQuery.style.switcher.js')}}"></script>
</body>
